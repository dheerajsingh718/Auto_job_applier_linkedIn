...
# Your legal name
first_name = "Dheeraj"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Singh"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Shankar"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "2017806773"        # Enter your 10 digit number in quotes Eg: "9876543210"
